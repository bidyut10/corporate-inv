  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-full text-xs px-3 py-2 border border-neutral-300 rounded-sm focus:outline-none focus:border-green-500 flex items-center justify-between bg-white cursor-pointer"
      >
